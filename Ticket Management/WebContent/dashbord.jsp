...
<c:forEach items="${object.raised_by_me}" var="l" >
    <tr>
        ...
        <td><button type="submit" id="${l.id}" onclick="viewComment(this)" name="viewComment" value="comments_${l.id}">View Comments</button></td>      
    </tr>
...
<c:forEach items="${object.closed}" var="l" >
    <tr>
        ...
        <td>${l.status}</td>
        <td>${l.type}</td>
        <td ><input class="cmt" type="button" id="${l.id}" value="viewComment" onclick="return viewComment()"></td>      
    </tr>
</c:forEach>
</table>
