...
<form id="add_comment" class="form-group" action="comment">
 ...
 <button type="submit" id="btn1">Share</button>
</form>
</div>
...
$("#add_comment").submit(function(e) {
    ...
    $.ajax({
           type: "POST",
           url: url,
           data: form.serialize()+"&userid="+x+"&tic_id="+z, // serializes the form's elements.
           success: function(data)
           {
        	   window.location='comment?id='+z; // show response from the php script.
           }
         });
